...
agent_communication:
  - agent: "main"
    message: "🚀 FASE 2.2 SISTEMA RECORDATORIOS AVANZADO COMPLETADO - Implementación completa de optimizaciones avanzadas: ✅ ESCALACIÓN AUTOMÁTICA: Sistema de prioridades (Normal→Urgente→Crítico), notificaciones a Admin/CEO y Coordinadora Abigail, lógica de supervisor según días vencidos, vendedores ven tareas escaladas en su panel. ✅ MÉTRICAS AVANZADAS: Dashboard de productividad con KPIs completos, conversiones (cotización/pedido/instalación), distribución de estados/tipos, métricas por usuario, datos listos para gráficos (pastel/barras), fix timezone aplicado. ✅ EXPORTACIÓN EXCEL/CSV: Mesa de Control con exportación completa, filtros por fecha/estado/usuario, enriquecimiento con datos de prospectos, formateo profesional, codificación base64. FASE 2 COMPLETAMENTE TERMINADA - Sistema robusto listo para producción."
  - agent: "main"
